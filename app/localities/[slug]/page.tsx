...
export default async function LocalityPage({
  ...
  // Next canary sometimes passes params as a Promise
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-3 text-neutral-300">
        JaipurCircle locality guide for <b>{label}</b>. We’ll expand this page
        with practical context, nearby landmarks, and curated events.
      </p>
